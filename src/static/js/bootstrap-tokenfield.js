...
(function (factory) {
  ...
  * ============================== */
  ...
  function Tokenfield(element, options) {
    var _self = this;
    ...
    if ( ! $.isEmptyObject( this.options.typeahead ) ) {
      ...
      var args = $.isArray( typeaheadOptions ) ? typeaheadOptions : [typeaheadOptions, typeaheadOptions];
  ...
  Tokenfield.prototype = {
    ...
    setInput: function (val) {
      ...
      if (val === '') {
        // Remove height if data is empty
    ...
    keydown: function (e) {
      ...
      function upDown(direction) {
        ...
        var position = direction === 'prev' ? 'first' : 'last';
    ...
    next: function (add) {
      ...
      var $nextToken = $lastActiveToken.nextAll('.token:first');
    ...
    prev: function (add) {
      ...
      var $firstActiveToken = this.$wrapper.find('.active:first');
      var $prevToken = $firstActiveToken.prevAll('.token:first');
    ...
    remove: function (e, direction) {
      ...
      var removeEvent = $.Event('tokenfield:removetoken', options);
...
// Automaticly adjust textarea size
